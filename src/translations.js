export const translations = {
  en: {
    ...
    hero: { title: "It's a pleasure to meet you !", subtitle: "Student at Claude Bernard University Lyon 1 | C++/Python Developer" },
    about: {
      title: "About Me",
    ...
    contact :{
        title:"Contact",
        p:"Feel free to contact me at kitapro@outlook.com or via social networks !",
  ...
  fr: {
    ...
    hero: { title: "Ravi de vous rencontrer !", subtitle: "Étudiant à l'Université Lyon 1 | Développeur C++/Python" },
    about: {
    ...
    contact :{
        title:"Contact",
        p:"N'hésitez pas à me contacter à kitapro@outlook.com ou via mes réseaux!",
        link: "kitapro@outlook.com",
    }
  }
};